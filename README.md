...
Este projeto ainda pode evoluir com:

- Melhor validação de dados (evitar erros de conversão)  
- Exibição mais detalhada do resultado (mostrar valor do IMC)  
...
Desenvolvido por **Felipe Correia**  
📌 Iniciante em Delphi, focado em evoluir continuamente na programação.
